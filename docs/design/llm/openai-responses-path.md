...
| **F-2** | A yaml/property surface for the registry override, `responsesApiEnabled`, and the sampling parameters. | Three programmatic-only knobs now. One config issue, not three riders. |
